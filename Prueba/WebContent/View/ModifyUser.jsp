...
<body>
	...
	window.onload = function(){
		for (var i=0; i<document.getElementById("Ids").options.length;i++){
			if (document.getElementsByName("Identificacion")[0].value==document.getElementById("Ids").options[i].value){
				document.getElementById("Ids").remove(i);
			}
		...
		for (var i=0; i<document.getElementById("Usuarios").options.length;i++){
			if (document.getElementsByName("Usuario")[0].value==document.getElementById("Usuarios").options[i].value){
				document.getElementById("Usuarios").remove(i);
			}
		}
	};
		function GuardarUsuario(){
			...
			+ "&accion=guardarCambiosUser&Rol="+document.getElementsByName("tb_Rol_idtb_Rol")[0].value+"&IdOld="+encodeURIComponent(document.getElementsByName("Identificacion_Old")[0].value);
			location.href = url;
	...
	<select id="Ids" class="form-control" style="display:none">
							...
							<c:forEach items="${Identif}" var="Id">
		...
		<div class="modal-body"> 
			<div id="rr" class="container"> 
				<div class="form-group"> 
					...
					<div class="col-md-4"> 
						<input name="Identificacion" type="text" placeholder="Ingresar Identificacion" value="${Ident}" class="form-control " required > 
					<input name="Identificacion_Old" type="hidden" placeholder="Ingresar Identificacion" value="${Ident}" class="form-control " required > 
		
					</div><br><br> 
					<label for="Nombre" class="control-label col-md-2">Nombre:</label> 
					<div class="col-md-4"> 
						<input name="Nombre" type="text" placeholder="Ingresar Nombre" value="${Nombr}" class="form-control " required > 
					</div><br><br> 
					<label for="Primer_apellido" class="control-label col-md-2">Primer Apellido:</label> 
					<div class="col-md-4"> 
						<input name="Primer_apellido" type="text" placeholder="Ingresar Primer apellido" value="${PApell}" class="form-control " required > 
					</div> 
				</div> 
				<div class="form-group "> 
					<label for="Segundo_apellido" class="control-label col-md-2">Segundo Apellido:</label> 
					<div class="col-md-4"> 
						<input name="Segundo_apellido" type="text" placeholder="Ingresar Segundo Apellido" value="${SApell}" class="form-control " > 
					</div> 
				</div> 
				<div class="form-group "> 
					<label for="Mail" class="control-label col-md-2">Correo Electronico:</label> 
					<div class="col-md-4"> 
						<input name="Mail" type="email" placeholder="Ingresar Correo electronico" value="${EMail}"class="form-control  " > 
					</div><br><br> 
					<label for="Telefono" class="control-label col-md-2">Telefono:</label> 
					<div class="col-md-4"> 
						<input name="Telefono" type="text" placeholder="Ingresar Telefono" value="${Tel}" class="form-control " > 
					</div><br><br>
	...
	<div class="col-md-4"> 
		<input name="Usuario" type="text" placeholder="Ingresar Usuario" value="${UsuarioDB}" class="form-control " > 
	</div><br><br> 
