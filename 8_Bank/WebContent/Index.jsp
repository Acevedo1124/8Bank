...
<html lang="en">
  ...
  <body>
    ...
    <header class="masthead">
      <div class="overlay">
        <div class="container">
          <h1 class="display-1 text-white">8 BANK</h1>
          <h2 class="display-4 text-white">HACEMOS PARTE DE TI</h2>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-6">
            <div class="p-5">
              ...
              <p><li>Compromiso: cumpiendo en tiempo y forma con las expectativas de nuestros clientes.</li>
                  ...
                  <li>Confianza: deja tus productos en las mejores manos. </li>
                  <li>Honestidad: garantizando la buena calidad del trabajo.</li>
