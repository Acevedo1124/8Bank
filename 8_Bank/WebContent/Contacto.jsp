...
<head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">AQUI VA EL LOGO</a>
                                            ...
                                            <div class="indent-left">
                                                ...
                                                <form id="contact-form" method="post" enctype="multipart/form-data">                    
                                                    <fieldset>
                                                          ...
                                                          <div class="wrapper">
                                                              <div class="text-form"><h6>Mensaje:</h6></div>
                                                            <div class="extra-wrap">
                                                                <textarea></textarea>
                                                                <div class="clear"></div>
                                                                <div class="buttons">
                                                                    <a class="button" href="#" onClick="document.getElementById('contact-form').reset()">Enviar</a>
                                                                </div> 
                                                            </div>
                                                          </div>                            
                                                    </fieldset>						
                                               ...
                                               <div class="box p4">
                                                    <div class="padding">
                                                        <div class="wrapper">
                                                            ...
                                                            <div class="extra-wrap">
                                                                <h3 class="p0">Horarios</h3>
                                                            </div>
                                                        </div>
                                                        <p class="color-1 p0"><strong>Lunes a Sabado</strong></p>
                                                        <p class="color-1 p0">Lunes-Viernes: 8:00am-9:00pm</p>
                                                        <p class="color-1 p1">Sabado: 8:00am-2:00pm</p>
                                                ...
                                                <div class="indent-left">
                                                    <dl class="main-address">
                                                        ...
                                                        <dd><span>Telefono:</span><h6>000 000 000</h6></dd>
